const MODEL_I18N = {
    "zh-CN": {
        ...
        "steps.one.desc": "Blockbench 里从 URL 加载插件，粘贴原作者提供的地址并确认。",
        "steps.two.title": "下载 Trae 国际版",
        "steps.two.desc": "进入 Trae 官网，点击 Download SOLO Desktop 下载桌面端。",
        "steps.three.title": "下载安装 Node.js",
        "steps.three.desc": "下载 Windows Installer，双击安装时一路点击下一步即可。",
        "steps.four.title": "登录并切到 Code",
        "steps.four.desc": "打开 Trae 后先登录账号，再点击左上角切换到 Code 模式。",
        "steps.five.title": "打开项目文件夹",
        "steps.five.desc": "点击选择文件夹，打开你的懒人包或模组项目目录。",
        "steps.six.title": "验证三个命令",
        "steps.six.desc": "在终端输入 node -v、npm -v、npx -v，三个都输出版本号就成功。",
        "steps.seven.title": "进入 MCP 手动配置",
        "steps.seven.desc": "打开设置里的 MCP 页面，点击添加并选择手动配置。",
        "steps.eight.title": "粘贴配置并确认",
        "steps.eight.desc": "把 MCP JSON 全部粘贴进输入框，检查无误后点击确认。",
        "steps.nine.title": "看到绿色勾",
        "steps.nine.desc": "blockbench 后面出现绿色勾就说明配置成功，失败就点重试。",
        "steps.ten.title": "重启后验证连接",
        "steps.ten.desc": "建议先关闭并重新打开 Trae，再让它通过 MCP 放一个方块。",
        "verify.kicker": "连接验证",
    ...
    "zh-TW": {
        ...
        "steps.one.desc": "Blockbench 裡從 URL 載入插件，貼上原作者提供的地址並確認。",
        "steps.two.title": "下載 Trae 國際版",
        "steps.two.desc": "進入 Trae 官網，點擊 Download SOLO Desktop 下載桌面端。",
        "steps.three.title": "下載安裝 Node.js",
        "steps.three.desc": "下載 Windows Installer，雙擊安裝時一路點擊下一步即可。",
        "steps.four.title": "登入並切到 Code",
        "steps.four.desc": "打開 Trae 後先登入帳號，再點擊左上角切換到 Code 模式。",
        "steps.five.title": "打開項目文件夾",
        "steps.five.desc": "點擊選擇文件夾，打開你的懶人包或模組項目目錄。",
        "steps.six.title": "驗證三個命令",
        "steps.six.desc": "在終端輸入 node -v、npm -v、npx -v，三個都輸出版本號就成功。",
        "steps.seven.title": "進入 MCP 手動配置",
        "steps.seven.desc": "打開設置裡的 MCP 頁面，點擊添加並選擇手動配置。",
        "steps.eight.title": "貼上配置並確認",
        "steps.eight.desc": "把 MCP JSON 全部貼上進輸入框，檢查無誤後點擊確認。",
        "steps.nine.title": "看到綠色勾",
        "steps.nine.desc": "blockbench 後面出現綠色勾就說明配置成功，失敗就點重試。",
        "steps.ten.title": "重啟後驗證連接",
        "steps.ten.desc": "建議先關閉並重新打開 Trae，再讓它通過 MCP 放一個方塊。",
        "verify.kicker": "連接驗證",
    ...
    en: {
        ...
        "steps.one.desc": "Load the plugin from URL in Blockbench, paste the original project URL, and confirm.",
        "steps.two.title": "Download Trae international",
        "steps.two.desc": "Open the Trae website and click Download SOLO Desktop.",
        "steps.three.title": "Install Node.js",
        "steps.three.desc": "Download Windows Installer, run it, and keep clicking Next through the installer.",
        "steps.four.title": "Log in and switch to Code",
        "steps.four.desc": "After opening Trae, log in first, then switch to Code mode from the top left.",
        "steps.five.title": "Open your project folder",
        "steps.five.desc": "Click Select Folder and open your lazy pack or mod project directory.",
        "steps.six.title": "Verify three commands",
        "steps.six.desc": "Run node -v, npm -v, and npx -v in the terminal. All three should print versions.",
        "steps.seven.title": "Open manual MCP config",
        "steps.seven.desc": "Open the MCP settings page, click Add, then choose manual config.",
        "steps.eight.title": "Paste config and confirm",
        "steps.eight.desc": "Paste the full MCP JSON into the input box, check it, then confirm.",
        "steps.nine.title": "Look for the green check",
        "steps.nine.desc": "A green check after blockbench means the config worked. If it fails, retry.",
        "steps.ten.title": "Restart and verify",
        "steps.ten.desc": "Close and reopen Trae first, then ask it to place one cube through MCP.",
